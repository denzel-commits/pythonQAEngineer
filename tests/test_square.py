...
class TestSquare:
    ...
    def test_square_name(self, side_a: int | float, expected_name: str):
    ...
    def test_square(self, side_a: int | float, expected_area: int | float, expected_perimeter: int | float):
        square_obj = Square(side_a)
        assert square_obj.area == expected_area
        assert square_obj.perimeter == expected_perimeter

    @pytest.mark.parametrize("side_a", [-2, -4, 0, "o"])
    def test_square_negative(self, side_a: int | float):
    ...
    def test_square_add_rectangle_area(self, square_obj: Square, rectangle_obj: Rectangle, expected_area: int | float):
    ...
    def test_square_add_circle_area(self, square_obj: Square, circle_obj: Circle, expected_area: int | float):
    ...
    def test_square_add_triangle_area(self, square_obj: Square, triangle_obj: Triangle, expected_area: int | float):
    ...
    def test_square_add_area_negative(self, square_obj: Square, other_obj: Mock):
        with pytest.raises(ValueError):
