...
class TestCircle:
    ...
    def test_circle_name(self, radius: int | float, expected_name: str):
    ...
    def test_circle(self, radius: int | float, expected_area: int | float, expected_perimeter: int | float):
        circle_obj = Circle(radius)
    ...
    def test_circle_add_rectangle_area(self, circle_obj: Circle, rectangle_obj: Rectangle, expected_area: int | float):
    ...
    def test_circle_add_triangle_area(self, circle_obj: Circle, triangle_obj: Triangle, expected_area: int | float):
    ...
    def test_circle_add_square_area(self, circle_obj: Circle, square_obj: Square, expected_area: int | float):
    ...
    def test_circle_add_area_negative(self, circle_obj: Circle, other_obj: Mock):
        with pytest.raises(ValueError):
